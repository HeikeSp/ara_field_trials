...
metabolite_arafield3_original <- read.table("data/Metabolite_AraField3.txt", header=TRUE, sep="\t")
...
colnames(metabolite_arafield3_original)[12:13] <- c("fumarate_neg", "fumarate")
