...
field2T_regressionACC_factor <- lm(LT50ACC ~ glc + frc + suc + raf + aa + mal + fum + pro + 
                                     factor(bbch) + factor(anthoscore), data = field2_trainT)
field3T_regressionACC_factor <- lm(LT50ACC ~ glc + frc + suc + raf + aa + mal + fum + pro + 
                                     factor(bbch) + factor(anthoscore), data = field3_trainT)
field4T_regressionACC_factor <- lm(LT50ACC ~ glc + frc + suc + raf + aa + mal + fum + pro + 
                                     factor(bbch) + factor(anthoscore), data = field4_trainT)
...
field2T_regressionACC_factorAIC <- step(field2T_regressionACC_null, 
                                       scope = formula(field2T_regressionACC_factor), 
                                       direction = "both")
# raf, fum, mal

field3T_regressionACC_factorAIC <- step(field3T_regressionACC_null, 
                                       scope = formula(field3T_regressionACC_factor), 
                                       direction = "both")
summary(field3T_regressionACC_factorAIC)
# factor(bbch), aa, suc

field4T_regressionACC_factorAIC <- step(field4T_regressionACC_null, 
...
step(field2T_regressionACC_factor, scope=formula(field2T_regressionACC_factor), direction="backward")
# AIC=72.58, mal, raf, fum

step(field3T_regressionACC_factor, scope=formula(field3T_regressionACC_factor), direction="backward")
# AIC=99.08, glc, raf, fum, pro --> minimal AIC (but small difference)
step(field3T_regressionACC_null, scope=formula(field3T_regressionACC_factor), direction="both")
# AIC=99.49, suc, aa, factor(bbch)
field3T_prediction_stepAIC_ACC_factor2 <- predict(field3T_regressionACC_factorAIC, field3_testT)

step(field4T_regressionACC_factor, scope=formula(field4T_regressionACC_factor), direction="backward")
